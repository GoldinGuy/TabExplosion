 ...
 *
 * https://www.npmjs.com/package/canvas-explosion
 *
 * ISC License
 *
 ...
 * Original file: /npm/canvas-explosion@1.2.0/dist/explosion.browser.js
 *
	...
	!(function t(e, n, o, a) {
		...
		var c,
			...
			g = (function () {
				...
				return function () {
					...
					if (!o && i) {
						var r = [
							"var explosion, SIZE = {}, module = {};",
							"(" + t.toString() + ")(this, module, true, SIZE);",
							"onmessage = function(msg) {",
							"  if (msg.data.options) {",
							"    explosion(msg.data.options).then(function () {",
							...
							"    explosion = module.exports.create(msg.data.canvas);",
							"  }",
							"}"
						].join("\n");
						try {
								...
								(t.fire = function (o, i, r) {
									...
									return (n = l(function (i) {
										...
										t.addEventListener("message", l),
											e(o, c),
											(a[c] = l.bind(null, { data: { callback: c } }));
									}));
								}),
								(t.reset = function () {
									for (var e in (t.postMessage({ reset: !0 }), a))
										a[e](), delete a[e];
								});
						})(e);
					}
		...
		function w(t, n) {
			var o,
				...
				u = a ? y : p,
				h = !(!t || !s) && !!t.__explosion_initialized,
				d =
			...
			function f(e, n, a) {
				...
				return o ? o.addParticles(E) : (o = M(t, E, u, n, a)).promise;
			}
			function m(n) {
		...
		(n.exports = w(null, { useWorker: !0, resize: !0 })),
			(n.exports.create = w);
	})(
		(function () {
